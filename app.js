...
loader.load('../assets/terra_certo.glb',
  function (gltf){
...
function onClickOpacity(){
  switch (b){
    case 0:
      ...
      group.children[4].visible = true;
      document.querySelector(".botao3").innerHTML = "<i class=\"far fa-hand-pointer\"></i> Terra + Nuvem";
      break;
    ...
    case 1:
      ...
      document.querySelector(".botao3").innerHTML = "<i class=\"far fa-hand-pointer\"></i> Cordenada";
      break;
    ...
    case 2:
      ...
      group.children[3].visible = false;
      group.children[4].visible = true;
      document.querySelector(".botao3").innerHTML = "<i class=\"far fa-hand-pointer\"></i> Terra";
      break;
  }
  console.log(b);
  b == 2 ? b = 0 : b++;
